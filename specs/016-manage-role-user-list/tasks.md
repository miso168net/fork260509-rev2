...
- [ ] T014 既有不破 + 契約守恆 + Constitution 自查（[verification §0](./contracts/verification-commands.md)）**對應 spec FR-011 + SC-007〔既有不破〕**：
