...
5. **審計欄 retrofit feature** — 既有業務表補 [constitution §I.6](../.specify/memory/constitution.md) 6 審計欄(尤其 `*_by` 缺口);forward-only 標準對新建表即時生效,本 feature 收攏既有表缺口(需寫入路徑帶入 operator 才填得了)。
