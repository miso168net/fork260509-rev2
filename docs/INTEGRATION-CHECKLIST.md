...
- **2026-06-03 constitution v1.2.3 amend(§I.3 業務碼文字校正 5xxx→2222、PATCH)**:§I.3 line 41 +§11.10 摘要列「business error 5xxx」對齊已出貨慣例 —— **2222=`BizError`(業務驗證)、5xxx=授權(5003)/基建(5000)**(`envelope.rs` 13-variant 矩陣、D8 早記);原句出處為 MOCK-AUDIT §4.11 設計建議(mock 不驗業務)、非實作真相。純文字零規則/zero code 變動;提案 of record DESIGN §11.18;觸發 021 `/speckit-analyze` C1 + workflow 對抗驗證(claim 不被 refute)
