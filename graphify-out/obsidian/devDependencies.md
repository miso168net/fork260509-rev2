...
- [[pro-naive-ui-resolver]] - `contains` [EXTRACTED]
- [[sass]] - `contains` [EXTRACTED]
- [[simple-git-hooks]] - `contains` [EXTRACTED]
- [[tsx]] - `contains` [EXTRACTED]
- [[typescript]] - `contains` [EXTRACTED]
- [[unocss]] - `contains` [EXTRACTED]
- [[unplugin-icons]] - `contains` [EXTRACTED]
- [[unplugin-vue-components]] - `contains` [EXTRACTED]
- [[vite]] - `contains` [EXTRACTED]
- [[vite-plugin-progress]] - `contains` [EXTRACTED]
- [[vite-plugin-svg-icons]] - `contains` [EXTRACTED]
- [[vite-plugin-vue-devtools]] - `contains` [EXTRACTED]
- [[vite-plugin-vue-transition-root-validator]] - `contains` [EXTRACTED]
