...
- [[_COMMUNITY_Color Palette Engine|Color Palette Engine]]
- [[_COMMUNITY_Build & Release Scripts|Build & Release Scripts]]
- [[_COMMUNITY_Alova Request Adapter (+docs)|Alova Request Adapter (+docs)]]
- [[_COMMUNITY_API Service Aliases (authcaptcha)|API Service Aliases (auth/captcha)]]
- [[_COMMUNITY_Form & Table Hooks|Form & Table Hooks]]
- [[_COMMUNITY_Admin Layout Package|Admin Layout Package]]
- [[_COMMUNITY_Theme Constants & Maps|Theme Constants & Maps]]
- [[_COMMUNITY_Runtime Dependencies|Runtime Dependencies]]
- [[_COMMUNITY_Theme & Settings UI|Theme & Settings UI]]
- [[_COMMUNITY_Global Type Declarations|Global Type Declarations]]
- [[_COMMUNITY_Auth Store & Permissions|Auth Store & Permissions]]
- [[_COMMUNITY_Form Validation & Bootstrap|Form Validation & Bootstrap]]
- [[_COMMUNITY_Naive UI Theme Tokens|Naive UI Theme Tokens]]
- [[_COMMUNITY_Layout Geometry & Scroll|Layout Geometry & Scroll]]
- [[_COMMUNITY_Dev Dependencies|Dev Dependencies]]
- [[_COMMUNITY_SVG Icon System|SVG Icon System]]
- [[_COMMUNITY_TypeScript Compiler Config (root)|TypeScript Compiler Config (root)]]
- [[_COMMUNITY_Chart Plugin Views|Chart Plugin Views]]
- [[_COMMUNITY_VS Code Workspace Settings|VS Code Workspace Settings]]
- [[_COMMUNITY_Route Type Hierarchy|Route Type Hierarchy]]
- [[_COMMUNITY_Docs Site TSConfig (NEW)|Docs Site TSConfig (NEW)]]
- [[_COMMUNITY_Global Search Module|Global Search Module]]
- [[_COMMUNITY_Common UI Toggle Components|Common UI Toggle Components]]
- [[_COMMUNITY_Global Layout Components|Global Layout Components]]
- [[_COMMUNITY_Elegant Router DSL|Elegant Router DSL]]
- [[_COMMUNITY_Route Helpers & Tab Filters|Route Helpers & Tab Filters]]
- [[_COMMUNITY_Per-Package TSConfig (sub-26)|Per-Package TSConfig (sub-26)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-27)|Per-Package TSConfig (sub-27)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-28)|Per-Package TSConfig (sub-28)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-29)|Per-Package TSConfig (sub-29)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-30)|Per-Package TSConfig (sub-30)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-31)|Per-Package TSConfig (sub-31)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-32)|Per-Package TSConfig (sub-32)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-33)|Per-Package TSConfig (sub-33)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-34)|Per-Package TSConfig (sub-34)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-35)|Per-Package TSConfig (sub-35)]]
- [[_COMMUNITY_Per-Package TSConfig (sub-36)|Per-Package TSConfig (sub-36)]]
- [[_COMMUNITY_Router Guard Flow (diagram)|Router Guard Flow (diagram)]]
...
- [[_COMMUNITY_Docs Site Package Metadata|Docs Site Package Metadata]]
...
- [[_COMMUNITY_Deploy & Integration Concepts|Deploy & Integration Concepts]]
...
- [[_COMMUNITY_Docs Site npm Scripts|Docs Site npm Scripts]]
- [[_COMMUNITY_Community 65|Community 65]]
- [[_COMMUNITY_Community 66|Community 66]]
- [[_COMMUNITY_Community 67|Community 67]]
- [[_COMMUNITY_Community 68|Community 68]]
- [[_COMMUNITY_VSCode Debugging Guide (3 screenshots)|VSCode Debugging Guide (3 screenshots)]]
- [[_COMMUNITY_Community 70|Community 70]]
- [[_COMMUNITY_Community 71|Community 71]]
- [[_COMMUNITY_Community 72|Community 72]]
- [[_COMMUNITY_Community 73|Community 73]]
- [[_COMMUNITY_Routing Guide Docs (CNJP)|Routing Guide Docs (CN/JP)]]
- [[_COMMUNITY_Docs Site DevDependencies|Docs Site DevDependencies]]
...
- [[_COMMUNITY_Theme & Icon Guide Docs|Theme & Icon Guide Docs]]
- [[_COMMUNITY_Community 87|Community 87]]
- [[_COMMUNITY_Community 88|Community 88]]
- [[_COMMUNITY_Getting Started  CLI Docs|Getting Started / CLI Docs]]
...
- [[_COMMUNITY_SPA Loading Screen UI|SPA Loading Screen UI]]
...
- [[_COMMUNITY_Router Guard Flow Image|Router Guard Flow Image]]
...
3. `request` - 17 edges
4. `$t (i18n global translator)` - 17 edges
5. `scripts` - 16 edges
6. `localStg` - 15 edges
...
- `WaveBg` --semantically_similar_to--> `SystemLogo 组件`  [INFERRED] [semantically similar]
  fork260509-soybean-admin-base/src/components/custom/wave-bg.vue → fork260509-soybean-admin-docs/src/zh/guide/theme/logo.md
- `createHookRequest()` --calls--> `createFlatRequest 实例创建实战`  [EXTRACTED]
  fork260509-soybean-admin-base/packages/hooks/src/use-request.ts → fork260509-soybean-admin-docs/src/zh/guide/request/usage.md
- `VitePress config (locales en/zh/jp, sidebar, algolia)` --references--> `useTable hook`  [EXTRACTED]
...
### Community 29 - "Per-Package TSConfig (sub-29)"
Cohesion: 0.12
Nodes (16): compilerOptions, allowSyntheticDefaultImports, esModuleInterop, forceConsistentCasingInFileNames, jsx, lib, module, moduleResolution (+8 more)

### Community 30 - "Per-Package TSConfig (sub-30)"
Cohesion: 0.12
Nodes (16): compilerOptions, allowSyntheticDefaultImports, esModuleInterop, forceConsistentCasingInFileNames, jsx, lib, module, moduleResolution (+8 more)
